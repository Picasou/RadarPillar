...
用法:
    python tools/utils/visual_utils/visualize_loss.py [LOG_PATH] [OUT_PNG]
...
def visualize_loss(steps, epoch_sorted, out: Path, title_suffix=""):
...
def main():
    ...
    visualize_loss(steps, epoch_sorted, out, title_suffix=f": {log.stem}")
