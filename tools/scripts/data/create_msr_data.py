...
对齐 plan Task 5: class_names 硬编码 ['1','2','4','5'](dataset yaml 无此 key);
data_path / save_path 都指 /mnt/d/DataSet/MSRv1(与 msr_dataset.yaml 的 DATA_PATH / INFO_PATH 解析路径一致)。
"""
import argparse
