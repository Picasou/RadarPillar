...
# eg. bash experiments/MC_DATASET/SH/train_msr_centerhead3d_noconv.sh
# MSR (MC_Single_Radar) RadarPillar CenterHead(3D) 变体 — RadarNeXtCenterHead
...
# —— 必改 ——
CFG_FILE="experiments/MC_DATASET/YAML/msr_centerhead3d_noconv.yaml"
BATCH_SIZE=4          # MSR 点云密集 + 8G 显存,保守起步;OOM 则降到 2
WORKERS=2
EPOCHS=80
GPU=0
EXTRA_TAG="msr_centerhead3d_noconv"
