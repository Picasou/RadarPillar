...
# eg. bash experiments/MC_DATASET/SH/train_msr_head2.sh
# MSR (MC_Single_Radar) RadarPillar PillarAttention 2 头变体 (NUM_HEADS=2)
...
# —— 必改 ——
CFG_FILE="experiments/MC_DATASET/YAML/msr_head2.yaml"
