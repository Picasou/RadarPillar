...
# eg. bash experiments/MC_DATASET/SH/train_msr_repdwcmix_mdfen_ch2d_trunk.sh
# MSR (MC_Single_Radar) RadarPillar RepDWC(32,64,64) + MDFEN[160] + ch2d trunk head 变体
...
# —— 必改 ——
CFG_FILE="experiments/MC_DATASET/YAML/msr_repdwcmix_mdfen_ch2d_trunk.yaml"
BATCH_SIZE=4          # MSR 点云密集 + 8G 显存,保守起步;OOM 则降到 2
WORKERS=2
EPOCHS=80
GPU=0
EXTRA_TAG="msr_repdwcmix_mdfen_ch2d_trunk"
