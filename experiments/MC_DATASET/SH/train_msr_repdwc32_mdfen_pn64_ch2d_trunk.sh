...
# eg. bash experiments/MC_DATASET/SH/train_msr_repdwc32_mdfen_pn64_ch2d_trunk.sh
# MSR (MC_Single_Radar) RadarPillar 行28 + VFE 升 64 — RepDWC(32,32,32) + MDFEN[96] + ch2d trunk
...
# —— 必改 ——
CFG_FILE="experiments/MC_DATASET/YAML/msr_repdwc32_mdfen_pn64_ch2d_trunk.yaml"
BATCH_SIZE=4          # MSR 点云密集 + 8G 显存,保守起步;OOM 则降到 2
WORKERS=2
EPOCHS=80
GPU=0
EXTRA_TAG="msr_repdwc32_mdfen_pn64_ch2d_trunk"
