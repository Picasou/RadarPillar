...
# eg. bash experiments/MC_DATASET/SH/train_msr_pp_strides_122_ch2d_trunk.sh
# MSR (MC_Single_Radar) RadarPillar PP LAYER_STRIDES [1,2,2] 首级不下采 + ch2d trunk head 变体
...
# —— 必改 ——
CFG_FILE="experiments/MC_DATASET/YAML/msr_pp_strides_122_ch2d_trunk.yaml"
BATCH_SIZE=4          # MSR 点云密集 + 8G 显存,保守起步;OOM 则降到 2
WORKERS=2
EPOCHS=80
GPU=0
EXTRA_TAG="msr_pp_strides_122_ch2d_trunk"
