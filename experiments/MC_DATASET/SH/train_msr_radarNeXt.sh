...
# eg. bash experiments/MC_DATASET/SH/train_msr_radarNeXt.sh
# MSR (MC_Single_Radar) RadarPillar RadarNeXt 原版复刻 — VFE64 + RepDWC[64,128,256] + MDFEN[384] + RadarNeXtCenterHead
...
# —— 必改 ——
CFG_FILE="experiments/MC_DATASET/YAML/msr_radarNeXt.yaml"
BATCH_SIZE=4          # MSR 点云密集 + 8G 显存,保守起步;OOM 则降到 2
WORKERS=2
EPOCHS=80
GPU=0
EXTRA_TAG="msr_radarNeXt"
