...
# [output 覆写: 让 train/test 直接写到 output/train_log/vod/<datetime>_rpillar_a4_rezero_rezero/]
OUTPUT_ROOT="output/train_log/vod/$(date +%Y%m%d%H%M)_rpillar_a4_rezero_rezero"
